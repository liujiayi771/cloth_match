sample_name = "/home/joey/Documents/data/tianchi_dapei/Taobao_Clothes_Matching_Data/test_items.txt"
...
for line in process_file.readlines():
    ...
    if tokens[0] in sample:
        with open("/home/joey/Documents/data/tianchi_dapei/Taobao_Clothes_Matching_Data/test_dim_items.txt", 'a+') as f:
            f.write(line)
            f.close()
